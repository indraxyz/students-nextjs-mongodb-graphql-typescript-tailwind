...
These utilities are located in `app/study-graphql/shared/utils/` as part of the shared utilities that can be reused across features.
...
```typescript
import { formatTime } from "@/app/study-graphql/shared/utils";
...
```typescript
import { getRelativeTime } from "@/app/study-graphql/shared/utils";
...
```typescript
import { isValidDate } from "@/app/study-graphql/shared/utils";
...
import {
  ...
  formatDate,
  getRelativeTime,
} from "@/app/study-graphql/shared/utils";
