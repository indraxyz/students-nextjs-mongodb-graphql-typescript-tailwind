  ...
  return (
    ...
    >
      <div className="w-full max-w-sm rounded-lg bg-white p-6 shadow-xl">
        <h3 className="text-lg font-semibold text-gray-900">Hapus student?</h3>
        <p className="mt-2 text-sm text-gray-600">
          Tindakan ini akan menghapus data <strong>{studentName}</strong> secara
          permanen. Anda yakin?
        </p>
        <div className="mt-6 flex gap-3">
          ...
          >
            {isProcessing ? "Menghapus..." : "Hapus Student"}
          </button>
        </div>
      </div>
    </div>
